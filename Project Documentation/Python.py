...
names [['Location', 'MinTemp', ', 'MaxTemp', 'Rainfall', 'WindGustSpeed", 'WindSpeed9am', 'WindSpeed3pm', 'Humidity9am', 'Humidity3pm', 'Pressure9am', 'Pressure3pm', 'Temp9am', 'Temp3pm', 'RainToday', "WindGustDir', 'WindDir9am', 'WindDir3pm', 'year', 'month', 'day']]
data pandas. DataFrame (features_values,columns-names)
data scale.fit_transform(data)
data pandas. DataFrame (data, columns names)
#predictions using the loaded model file
prediction model.predict(data)
pred prob model.predict_proba (data)
print(prediction)
if prediction == "Yes":
else:
